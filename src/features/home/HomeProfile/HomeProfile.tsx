...
export default function HomeProfile() {
  ...
  return (
    <Element
      name="profile"
      className="profile-container flex flex-col items-center justify-center gap-2 px-4 pt-[144px] sm:ml-[calc(-50vw+50%)] sm:w-screen"
    >
      <div className="content translate-y-[200px] opacity-0">
        ...
        <div className="bg-#d12d31 flex gap-2 rounded-2xl bg-stone-50 px-2 py-3 shadow-2xl sm:px-6 sm:py-6">
