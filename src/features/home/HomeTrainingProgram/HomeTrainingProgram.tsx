    ...
    <div className="training-program-container flex flex-col items-center justify-center gap-8 px-4 pb-[124px] pt-[144px] sm:ml-[calc(-50vw+50%)] sm:w-screen sm:gap-16 sm:pb-[234px]">
      ...
      <div className="flex flex-col gap-8 sm:w-[1024px] sm:gap-16">
        <div className="program1 relative flex items-center gap-4">
          <div>
            <div className="relative w-[110px] rounded-2xl bg-primary p-2 text-center font-extrabold text-white sm:w-[328px] sm:p-3 sm:text-2xl">
              {t('title1')}
            </div>
          </div>
        ...
        <div className="relative">
          <div className="program3 relative z-10 w-[110px] rounded-2xl bg-primary p-2 text-center font-extrabold text-white sm:w-[328px] sm:p-3 sm:text-2xl">
            {t('title3')}
          </div>
          ...
          <div
            data-aos-offset="-20"
            className="program4 absolute -bottom-[124px] left-[94px] z-10 w-[110px] rounded-2xl bg-primary p-2 text-center font-extrabold text-white sm:-bottom-[234px] sm:left-[218px] sm:w-[328px] sm:min-w-[232px] sm:p-3 sm:text-2xl"
          >
            {t('title4')}
          </div>
          <div className="program5 absolute -bottom-[34px] left-[140px] z-10 min-w-[110px] rounded-2xl bg-primary p-2 text-center font-extrabold text-white sm:-bottom-[74px] sm:left-[346px] sm:w-[328px] sm:p-3 sm:text-2xl">
            {t('title5')}
          </div>
        </div>
      </div>
